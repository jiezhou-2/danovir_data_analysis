...
### Model 1 : third order model + independent error
...
mainEffect1=gls(value_reported~arm+ antigen+detect_reagent+assay+ arm:antigen+arm:detect_reagent+antigen:detect_reagent+arm:antigen:detect_reagent,data = data15 ,method = "ML")
...
### Mode 2 : third order model + independent error + feature-specific variance
...
### Model 3: third order model + random intercept + feature-specific variance
