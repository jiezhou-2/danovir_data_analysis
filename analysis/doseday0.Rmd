...
### Model 2: full model + random intercept + feature-specific error


$$infant_{ijkl}=\mu +  \alpha_j + \beta_k + \lambda_l+\gamma_{1lj}+\gamma_{2lk}+ \gamma_{3jk}+\gamma_{4jkl}+u_i+ e_{ijk}, e_{ijk}\sim N(0,\sigma_{jk})$$

```{r,message=FALSE,echo=FALSE}
# mainEffect3=lme(value_reported~arm+ antigen+detect_reagent+assay+ arm:antigen+arm:detect_reagent+antigen:detect_reagent+arm:antigen:detect_reagent,random=pdDiag(~1|antigen/detect_reagent),weights = varIdent(form = ~1),data = data15,method = "ML",control = contr)

mainEffect3=lme(
value_reported~arm+ antigen+detect_reagent+assay+ arm:antigen+arm:detect_reagent+antigen:detect_reagent+arm:antigen:detect_reagent,
correlation = corCompSymm(form=~1|subject_accession),
weights = varIdent(form=~1|detect_reagent),
random=pdDiag(form = ~antigen), data = data15,method = "ML",control = contr)
...
### Model 3: full model + random intercept+ random antigen+ random antibody+ random antigen:antibody + homoscedastic error
...
```{r,message=FALSE,echo=FALSE}
mainEffect3=lme(value_reported~arm+ antigen+detect_reagent+assay+ arm:antigen+arm:detect_reagent+antigen:detect_reagent+arm:antigen:detect_reagent,random=pdDiag(~1|antigen*antibody),weights = varIdent(form = ~1),data = data15,method = "ML",control = contr)
aa=summary(mainEffect3)
```
...
### Model 4: full model + random intercept+ random antigen+ random antigen:antibody + homoscedastic error


$$infant_{ijkl}=\mu +  \alpha_j + \beta_k + \lambda_l+\gamma_{1lj}+\gamma_{2lk}+ \gamma_{3jk}+\gamma_{4jkl}+u_i+ u_{ij}+u_{ik}+ e_{ijk}, e_{ijk}\sim N(0,\sigma^2)$$

```{r,message=FALSE,echo=FALSE}
mainEffect3=lme(value_reported~arm+ antigen+detect_reagent+assay+ arm:antigen+arm:detect_reagent+antigen:detect_reagent+arm:antigen:detect_reagent,random=pdDiag(~antigen+antigen:antibody),weights = varIdent(form = ~1),data = data15,method = "ML",control = contr)
aa=summary(mainEffect3)
```
...
### Model 5: full model + random intercept+ random antibody+ random antigen:antibody + homoscedastic error


$$infant_{ijkl}=\mu +  \alpha_j + \beta_k + \lambda_l+\gamma_{1lj}+\gamma_{2lk}+ \gamma_{3jk}+\gamma_{4jkl}+u_i+ u_{ij}+u_{ik}+ e_{ijk}, e_{ijk}\sim N(0,\sigma^2)$$

```{r,message=FALSE,echo=FALSE}
mainEffect3=lme(value_reported~arm+ antigen+detect_reagent+assay+ arm:antigen+arm:detect_reagent+antigen:detect_reagent+arm:antigen:detect_reagent,random=pdDiag(~antibody+antigen:antibody),weights = varIdent(form = ~1),data = data15,method = "ML",control = contr)
aa=summary(mainEffect3)
```
...
### Model 6: full model + random intercept+ random antigen:antibody + homoscedastic error


$$infant_{ijkl}=\mu +  \alpha_j + \beta_k + \lambda_l+\gamma_{1lj}+\gamma_{2lk}+ \gamma_{3jk}+\gamma_{4jkl}+u_i+ u_{ij}+u_{ik}+ e_{ijk}, e_{ijk}\sim N(0,\sigma^2)$$

```{r,message=FALSE,echo=FALSE}
mainEffect3=lme(value_reported~arm+ antigen+detect_reagent+assay+ arm:antigen+arm:detect_reagent+antigen:detect_reagent+arm:antigen:detect_reagent,random=pdDiag(~antigen:antibody),weights = varIdent(form = ~1),data = data15,method = "ML",control = contr)
aa=summary(mainEffect3)
```
