...
```{r,message=FALSE,echo=FALSE}
mainEffect3=lme(value_reported~arm+ antigen+detect_reagent+assay+ arm:antigen+arm:detect_reagent+antigen:detect_reagent+arm:antigen:detect_reagent,random=pdDiag(~antigen+detect_reagent+antigen:detect_reagent),weights = varIdent(form = ~1),data = data15,method = "ML",control = contr)
aa=summary(mainEffect3)
```
